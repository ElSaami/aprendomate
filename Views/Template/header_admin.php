...
<html lang="es">
    <head>
        ...
        <link rel="shorcut icon" href="<?= media();?>/images/logo_dashboard.png">
    ...
    <body class="app sidebar-mini">
        ...
        <div class="containerLOGO">
            ...
            <img class="app-sidebar__logoAprendo" src="<?=media();?>/images/logo_dashboard.png" alt="User Image">AprendoMate</a>
        </div>
